<template>
  <v-container fluid>
    <v-col col="12" style="border: 1px solid cadetblue">
      <v-row class="xs" justify="center" style="border: 1px solid red">
        <v-col cols="12" style="border: 1px solid white">
          <p class="text-center text-h2">
            Nous Contacter
          </p>
        </v-col>
      </v-row>
      <v-col cols="12" style="border: 1px solid green" class="my-5">
        <v-row style="border: 1px solid orange" align-content="stretch">
          <v-col cols="5" style="border: 1px solid violet">
            ...
            <div>
              <GmapMap :center="{lat: 44.292722463057046, lng: 4.4751635920859085}" :zoom="17" style="width: 60%; height: 300px;" />
            </div>
          </v-col>
          <v-col
